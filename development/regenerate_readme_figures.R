...
catalog_sbs96 <- data.frame(
  sample1 = sbs96_df[, 3],
  row.names = mSigPlot::catalog_row_order()$SBS96
)
save_fig(
...
# SBS192
sbs192_df <- read.csv(system.file(
  "extdata",
  "regress.cat.sbs.192.csv",
  package = "mSigPlot"
))
catalog_sbs192 <- data.frame(
  sample1 = sbs192_df[, 4],
  row.names = mSigPlot::catalog_row_order()$SBS192
)
save_fig(
...
# SBS1536
sbs1536_df <- read.csv(system.file(
  "extdata",
  "regress.cat.sbs.1536.csv",
  package = "mSigPlot"
))
catalog_sbs1536 <- data.frame(
  sample1 = sbs1536_df[, 3],
  row.names = mSigPlot::catalog_row_order()$SBS1536
)
save_fig(
...
# DBS144
dbs144_df <- read.csv(system.file(
  "extdata",
  "regress.cat.dbs.144.csv",
  package = "mSigPlot"
))
catalog_dbs144 <- data.frame(
  sample1 = dbs144_df[, 4],
  row.names = mSigPlot::catalog_row_order()$DBS144
)
save_fig(
...
catalog_id166 <- data.frame(
  sample1 = id166_vec,
  row.names = mSigPlot::catalog_row_order()$ID166
)
save_fig(
  plot_ID166(catalog_id166, plot_title = "Example ID166 (synthetic)"),
  "example_ID166",
  width = 10,
  height = 4
)
